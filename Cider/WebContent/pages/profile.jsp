                    ...
                    <h1 class="page-header">Profile</h1>
							<form action="../operation/pprofile.jsp" method="post">
								<table class="table table-hover">
									...
									<tr>
										<td>비밀번호 : </td>
										<td><input type="password" name=pw placeholder="비밀번호" value="<%=rs.getString("pw") %>"></td>
									</tr>
									<tr>
										<td>이름 : </td>
									...
									<tr>
										<td>전화번호 : </td>
										<td><input type="text" name=pn place holder="전화번호" value="<%=rs.getString("pn") %>"></td>
									</tr>
									<tr>
										<td align="left"><input type="submit" class="btn btn-default" value="수정하기"></td>
									</tr>
									</tbody>
								</table>
							</form>
