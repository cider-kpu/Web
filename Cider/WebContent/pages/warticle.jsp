            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <h1 class="page-header">글 쓰기</h1>
						<form id="frm" action="../operation/insert.jsp?bcode=<%=bcode %>" method="post" >
							<table width="100%">
								<tr>
									<td>제목</td>
								...
								<tr>
									<td colspan="2">
										...
										<a href="../pages/vboard.jsp?bcode=<%=bcode %>"><button type="button" class="btn btn-default">취소</button></a>
									</td>
								</tr>
							</table>
						</form>
